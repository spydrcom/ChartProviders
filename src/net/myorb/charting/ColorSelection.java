...
public abstract class ColorSelection extends DisplayGraphTypes.ColorMap
{
	...
	/**
	 * optional hook for producing legend display
	 */
	public void legend () {}

	/**
	 * optional hook for producing data dump
	 */
	public void dump () {}
	 ...
	 * @param forItem the value being assigned color
	 * @param hueValue the hue of the color (H of HSB)
	 * @param saturate the saturation of the color (S of HSB)
	 * @param brill the brilliance of the color (B of HSB)
	 */
	public void setColor (long forItem, float hueValue, float saturate, float brill)
	{ put ((int) forItem, Color.getHSBColor (hueValue, saturate, brill)); }
